...
public class HumanNervousSystem {
    ...
    private float[] bodyStateArray = new float[20];
    ...
    public void updateBodyState(){
        ...
        if (this.thisHuman.LHState == true){
            bodyStateArray[bodyStateIndexDict["holding LH"]] = 1.0f;
        }
        else{
            bodyStateArray[bodyStateIndexDict["holding LH"]] = 0.0f;
        }

        if (this.thisHuman.RHState == true){
            bodyStateArray[bodyStateIndexDict["holding RH"]] = 1.0f;
        }
        else{
            bodyStateArray[bodyStateIndexDict["holding RH"]] = 0.0f;
        }
    }

    public float[] GetBodyState(){
        updateBodyState();
    ...
    {
        // we need a gene or a constant added to human.Config that specifies the visual refresh rate
        // 1
