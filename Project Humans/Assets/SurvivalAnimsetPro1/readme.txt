Survival Animset Pro vol.1
--------------------------

This pack contains 78 survival and crafting themed animations for Third Person Perspective (TPP) characters.
...
The animations can be played out-of-the-box on any character, that uses Unity's Humanoid Rig. However in this pack, the props (axe, hoe, hammer etc.) are also animated. If you want to use those animations alongside the body animations, Your character must have the same bone structure as the original animation character. Please preceed with these steps:
