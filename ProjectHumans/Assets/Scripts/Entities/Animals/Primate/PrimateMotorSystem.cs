...
public class PrimateMotorSystem : MotorSystem
{
    ...
    public PrimateMotorSystem(Animal animal) : base(animal)
    {
        ...
        leg = thisAnimal.GetGameObject().transform.GetChild(0).GetChild(2).Find("Femur_R").GetComponent<ConfigurableJoint>();
        Debug.Log(leg);
    }
    ...
    public override void TakeSteps()
    {
        ...
        abdomenTrans.Translate(thisBody.GetGameObject().transform.forward * stepProportion * Time.deltaTime);
    }
